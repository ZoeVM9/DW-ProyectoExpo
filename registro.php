            ...
            <li class="nav-item">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="usuario.php"><i class="fas fa-users"></i> Usuarios</a>
        ...
        <div id="content">
                ...
                <div class="col-auto text-center">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/registroAdd.php"  method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                  <input class="form-control" name="user" type="text" placeholder="Nombre de usuario" required>
                                </div>
                                <div class="mb-3">
                                  <input class="form-control" name="fecnac" type="date" placeholder="Fecha de nacimiento" required>
                                </div>
                                <div class="mb-3">
